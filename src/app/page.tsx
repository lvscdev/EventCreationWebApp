...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col lg:flex-row bg-[#0B0000] overflow-hidden">
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="flex flex-col gap-5 w-full">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-white/70 text-sm font-medium font-urbanist">Email Address</label>
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label className="text-white/70 text-sm font-medium font-urbanist">Password</label>
              <div className="flex items-center px-4 py-3 rounded-lg border border-white/25 bg-white/10 focus-within:border-[#FF772B] transition">
                <input
            ...
            {/* Forgot Password */}
            <div>
              <a href="#" className="text-[#FF772B] text-xs font-urbanist underline">
                Forgot password?
              </a>
            </div>
      ...
      {/* ===== Right Image Section ===== */}
      <div className="relative w-full lg flex items-center justify-center overflow-hidden">
